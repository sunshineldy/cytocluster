...
/*    
	...
	private JScrollPane createAlgorithmPanel() {
     ...
     //   choicePanel.setPreferredSize(new Dimension(270, 200));
		
    	JPanel choicePanelNonOverlapping = new JPanel();
    	JPanel choicePanelOverlapping = new JPanel();
        choicePanelNonOverlapping.setLayout(new BoxLayout(choicePanelNonOverlapping, BoxLayout.Y_AXIS));
        choicePanelOverlapping.setLayout(new BoxLayout(choicePanelOverlapping, BoxLayout.Y_AXIS));
        ...
        choicePanelNonOverlapping.setBorder(BorderFactory.createTitledBorder("NonOverlapping"));
        choicePanelOverlapping.setBorder(BorderFactory.createTitledBorder("Overlapping"));
     ...
     */
        ...
        choicePanelNonOverlapping.add(algorithm1);
