...
public class ClusterGraph {
	...
	public ClusterGraph(CyRootNetwork rootNetwork, Collection nodes,
			Collection edges, ClusterUtil mcodeUtil) {
		if (rootNetwork == null)
	...
	public List getAdjacentEdgeList(CyNode node, Type edgeType) {
	...
	public List getConnectingEdgeList(CyNode source, CyNode target,
			org.cytoscape.model.CyEdge.Type edgeType) {
