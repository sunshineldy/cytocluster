 ...
 *
 */
public class VisualStyleAction extends AbstractVizAction implements
	...
	public VisualStyleAction(String title,
			CyApplicationManager applicationManager,
			CySwingApplication swingApplication,
			CyNetworkViewManager netViewManager,
			VisualMappingManager visualMappingMgr, ClusterUtil mcodeUtil) {
