...
public class DiscardResultAction extends AbstractVizAction {
	...
	public DiscardResultAction(String name, int resultId,
	...
	public void actionPerformed(java.awt.event.ActionEvent event) {
		...
		if (panel != null) {
			...
			boolean requestUserConfirmation = Boolean.valueOf(
					getValue("requestUserConfirmation").toString())
					.booleanValue();
			if (requestUserConfirmation) {
				String message = (new StringBuilder(
						"You are about to dispose of Result "))
						.append(resultId).append(".\nDo you wish to continue?")
						.toString();
				confirmed = Integer.valueOf(JOptionPane.showOptionDialog(
						swingApplication.getJFrame(),
						((Object) (new Object[] { message })), "Confirm", 0, 3,
						null, null, null));
			}
